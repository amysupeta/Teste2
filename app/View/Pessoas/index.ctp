					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Pessoa'), array('action' => 'add'), array('escape' => false)); ?></li>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($pessoas as $pessoa): ?>
					<tr>
						...
						<td><?php echo h($pessoa['Pessoa']['distrito']); ?>&nbsp;</td>
						<td><?php echo h($pessoa['Pessoa']['bi']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $pessoa['Pessoa']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $pessoa['Pessoa']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $pessoa['Pessoa']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $pessoa['Pessoa']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
