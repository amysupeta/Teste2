<?php
echo $this->Form->create(array('controller' => 'filmes', 'action' => 'listarFilmePordata', 'type' => 'post'));
echo $this->Form->input('buscador', array('placeholder' => 'insert date1 yyyy-mm-dd', 'label' => false));
echo $this->Form->end('Listar');
?>
<div class="row">
		<div class="col-md-12">
