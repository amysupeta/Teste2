<?php
echo $this->Form->create(array('controller' => 'filmes', 'action' => 'listarFilmeCategoria', 'type' => 'post'));
echo $this->Form->input('buscador', array('class' => 'form-control','placeholder' => 'insert categoria id', 'label' => false));
